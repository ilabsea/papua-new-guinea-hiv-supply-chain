...
describe OrderLineImport do
  before(:each) do
    ...
    @order_line_import = OrderLineImport.new @excel_file
  ...
  describe '#order_number' do
    it 'return order_number from excel template' do
      @order_line_import.order_number.should eq  '#0001'
    end
  end

  describe '#load_arv_test' do
    it "should load data to orderline in database from excell file tabbed 1" do
      @order_line_import.load_arv_test(@order)
  ...
  describe '#load_arv_req' do
    it "should load data to order lines in database from excell tabbed 0" do
      @order_line_import.load_arv_req(@order)
      order_lines = OrderLine.all
